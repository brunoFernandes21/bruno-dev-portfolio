  ...
  return (
    <div className=" text-center mx-auto mt-5 w-[90%] md:hidden text-white">
      ...
      {booksBuzzStack && (<Slider {...settings}>
          ...
          <section className=" bg-slate-900 w-md mx-auto shadow-md rounded-md">
            <Image
              src="/images/books-buzz1.png"
              className="mx-auto rounded-t"
              width={500}
            ...
            <section className="px-4 w-md pb-6 pt-4">
              ...
              <div className="max-w-md mx-auto">
                <p className="text-slate-100 font-black leading-8 text-left">
                  ...
                  fairly easy for users to switch from light and dark mode by
                  simply clicking on the moon icon on the right side of the
                  navigation bar. Click the moon icon to see dark mode in
                  action. Dark mode is ideal at night time. It’s better for
                  low-light settings – so you can use it in bed without keeping
                  your partner awake. It can potentially reduce eye strain and
                  dry eyes in low-light conditions.
                </p>
              </div>
            </section>
          </section>
          ...
          <section className=" bg-slate-900  w-md mx-auto shadow-md rounded-md">
            ...
            <section className="px-4 w-md pb-6 pt-4">
              ...
              <div className="max-w-md mx-auto">
                <p className="text-slate-100 font-black leading-8 text-left">
                  When you click on an article in the home page, you are taken
                  to the article&apos;s page where you can read the article,
                  like and dislike it. You can also see how many comments this
                  article has recieved so far. When you like or dislike, the
                  likes count goes up or down accordingly.
                </p>
              </div>
            </section>
          </section>
            ...
            <section className="px-4 w-md pb-6 pt-4">
              ...
              <div className="max-w-md mx-auto">
                <p className="text-slate-100 font-black leading-8 text-left">
                  ...
                  also able to see all the comments related to the article by
                  clicking show comments and delete your comments in case you
                  change your mind. Bear in mind that as a user, you are only
